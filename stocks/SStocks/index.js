const SStocksDay=require('./DayMovement.json');
const SStocksWeek=require('./WeekMovement.json');
const SStocksMonth=require('./MonthMovement.json');
const { randomLivePrice }=require('../../helper/randomLivePrice');

function listSLivePrice(){
    // testing
    ...
    let stockValues=SStocksDay.values;
...
function listSStocksDayHistory(){
     // testing
   const newYorkDate = new Date().toLocaleString('en-US', { timeZone: 'America/Tegucigalpa' });
...
function listSStocksWeekHistory(){
    return SStocksWeek;
}
function listSStocksMonthHistory(){
    return SStocksMonth;
}

module.exports={ listSLivePrice, listSStocksDayHistory, listSStocksWeekHistory, listSStocksMonthHistory };
