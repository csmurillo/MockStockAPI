const BStocksDay=require('./DayMovementStocks.json');
const BStocksWeek=require('./WeekMovementStocks.json');
const BStocksMonth=require('./MonthMovementStocks.json');
...
function listBStocksWeekHistory(){
    return BStocksWeek;
}
function listBStocksMonthHistory(){
    return BStocksMonth;
}

module.exports={ listBLivePrice, listBStocksDayHistory, listBStocksWeekHistory, listBStocksMonthHistory };
