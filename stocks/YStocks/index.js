const YStocksDay=require('./DayMovement.json');
const YStocksWeek=require('./WeekMovement.json');
const YStocksMonth=require('./MonthMovement.json');
const { randomLivePrice }=require('../../helper/randomLivePrice');

function listYLivePrice(){
    // testing
    ...
    let stockValues=YStocksDay.values;
...
function listYStocksDayHistory(){
     // testing
     const newYorkDate = new Date().toLocaleString('en-US', { timeZone: 'America/Tegucigalpa' });
...
function listYStocksWeekHistory(){
    return YStocksWeek;
}
function listYStocksMonthHistory(){
    return YStocksMonth;
}

module.exports={ listYLivePrice, listYStocksDayHistory, listYStocksWeekHistory, listYStocksMonthHistory };
