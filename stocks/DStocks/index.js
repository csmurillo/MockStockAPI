const DStocksDay=require('./DayMovement.json');
const DStocksWeek=require('./WeekMovement.json');
const DStocksMonth=require('./MonthMovement.json');
const { randomLivePrice }=require('../../helper/randomLivePrice');

function listDLivePrice(){
    // testing
    ...
    let stockValues=DStocksDay.values;
...
function listDStocksDayHistory(){
    // testing
    const newYorkDate = new Date().toLocaleString('en-US', { timeZone: 'America/Tegucigalpa' });
...
function listDStocksWeekHistory(){
    return DStocksWeek;
}
function listDStocksMonthHistory(){
    return DStocksMonth;
}

module.exports={ listDLivePrice, listDStocksDayHistory, listDStocksWeekHistory, listDStocksMonthHistory };
