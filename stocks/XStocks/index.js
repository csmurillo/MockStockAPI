const XStocksDay=require('./DayMovement.json');
const XStocksWeek=require('./WeekMovement.json');
const XStocksMonth=require('./MonthMovement.json');
const { randomLivePrice }=require('../../helper/randomLivePrice');

function listXLivePrice(){
    // testing
    const newYorkDate = new Date().toLocaleString('en-US', { timeZone: 'America/Tegucigalpa' });
    // const newYorkDate = new Date().toLocaleString('en-US', { timeZone: 'America/Tegucigalpa' });
    ...
    let stockValues=XStocksDay.values;
...
function listXStocksDayHistory(){
           // testing
           const newYorkDate = new Date().toLocaleString('en-US', { timeZone: 'America/Tegucigalpa' });
...
function listXStocksWeekHistory(){
    return XStocksWeek;
}
function listXStocksMonthHistory(){
    return XStocksMonth;
}

module.exports={ listXLivePrice, listXStocksDayHistory, listXStocksWeekHistory, listXStocksMonthHistory };
